...
%%% first author
\author{Prashanth Irudayaraj
    \affiliation{
	Research Manager\\
	Keep Network\\
    Email: prashanth@keep.network
    }	
}
...
\author{Antonio Cordozo\thanks{Address all correspondence to this author.} \\
...
\author{Tilde Uusalito\thanks{Address all correspondence to this author.} \\
	{\tensfb Second Coauthor}     
 \affiliation{Department or Division Name\\
 Keep Network\\
